...
const add_id = "puvthkmcqhnjjwsf"; // app_id
const app_secret = "NENzYmNiVnZPZFhqQlV0Z3FHTkRaZz09"; // app_secret
const key = "32612bb02b59489da529e795ae2aad2f"; // key
function getWeather() {
...
$("#bash").mouseover(function () {
    $("#link-text").html("体验子主页");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
