!(function (e, t) {
  ...
  return (function (e) {
      ...
      var i = /mobile/i.test(window.navigator.userAgent),
        a = {
          ...
          getElementViewTop: function (e, t) {
            ...
            return (
              (n = document.body.scrollTop + document.documentElement.scrollTop), t ? i : i - n
            );
          },
          isMobile: i,
          storage: {
            ...
            a(e, [
              {
                ...
                value: function () {
                  ...
                  this.player.template.list.addEventListener("click", function (t) {
                    ...
                    var i =
                      parseInt(n.getElementsByClassName("aplayer-list-index")[0].innerHTML) - 1;
              ...
              },
              {
                ...
                value: function () {
                  this.player.events.trigger("listshow"),
                    ...
                    (this.player.template.listOl.scroll({
                      top: 32 * this.index,
                      behavior: "smooth",
                    }));
                },
              ...
              },
              {
                key: "toggle",
                value: function () {
                  this.player.template.list.classList.contains("aplayer-list-hide")
                    ? this.show()
                    : this.hide();
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  (this.player.template.listOl.innerHTML += (0, r.default)({
                    ...
                    (this.player.randomOrder = o.default.randomOrder(this.audios.length)),
                    (this.player.template.listCurs =
                      this.player.container.querySelectorAll(".aplayer-list-cur")),
                    (this.player.template.listCurs[this.audios.length - 1].style.backgroundColor =
                ...
                value: function (e) {
                  if (
                    ...
                    (this.player.template.pic.style.backgroundImage = t.cover
                      ...
                      : ""),
                      this.player.theme(
                        this.audios[this.index].theme || this.player.options.theme,
                        this.index,
                        !1,
                      ),
                    ...
                    n && n.classList.remove("aplayer-list-light"),
                      ...
                      (0, s.default)(32 * this.index, 500, null, this.player.template.listOl),
                      ...
                      1 !== this.player.duration &&
                        (this.player.template.dtime.innerHTML = o.default.secondToTime(
              ...
              },
              {
                ...
                value: function () {
                  this.player.events.trigger("listclear"),
                    ...
                    (this.player.template.dtime.innerHTML = o.default.secondToTime(0));
                },
              },
            ]),
            e
                  ...
                  this.loadingChecker = setInterval(function () {
                    e.enableloadingChecker &&
                      ...
                      i ||
                        ...
                        (e.player.container.classList.add("aplayer-loading"), (i = !0)),
                      i &&
                        n > t &&
                        !e.player.audio.paused &&
                        (e.player.container.classList.remove("aplayer-loading"), (i = !1)),
                      (t = n));
                  }, 100);
                },
              },
          ...
          return (
            a(e, [
                    ...
                    n = function n(i) {
                      ...
                      var a =
                        ...
                        ((i.clientY || i.changedTouches[0].clientY) -
                          ...
                          e.player.template.volumeBar.clientHeight;
                      (a = Math.max(a, 0)), (a = Math.min(a, 1)), e.player.volume(a);
                    };
                  ...
                  this.player.template.order.addEventListener("click", function () {
                    "list" === e.player.options.order
                      ? ((e.player.options.order = "random"),
                        (e.player.template.order.innerHTML = o.default.orderRandom))
                      : "random" === e.player.options.order &&
                        ((e.player.options.order = "list"),
                        (e.player.template.order.innerHTML = o.default.orderList));
                  });
                },
              },
              {
                    ...
                    e.player.list.audios.length > 1
                      ? "one" === e.player.options.loop
                        ? ((e.player.options.loop = "none"),
                          (e.player.template.loop.innerHTML = o.default.loopNone))
                        : "none" === e.player.options.loop
                        ? ((e.player.options.loop = "all"),
                          (e.player.template.loop.innerHTML = o.default.loopAll))
                        : "all" === e.player.options.loop &&
                          ((e.player.options.loop = "one"),
                          (e.player.template.loop.innerHTML = o.default.loopOne))
              ...
              },
              {
                ...
                value: function () {
                    var e = this;
                    sessionStorage.getItem("ac") ? (e.ac = sessionStorage.getItem("ac")) : null;
                    "collapsed" === e.ac ? e.player.template.list.classList.add("aplayer-list-hide") : e.player.template.list.classList.remove("aplayer-list-hide");
                    this.player.template.menu.addEventListener("click", function () {
                        e.player.list.toggle(),
                        e.player.template.list.classList.contains("aplayer-list-hide")
                            ? (e.ac = "collapsed",sessionStorage.setItem("ac", e.ac))
                            : (e.ac = "expanded",sessionStorage.setItem("ac", e.ac)),
                        "collapsed" === e.ac
                            ? (e.player.template.lrcWrap.style.bottom =
                                e.player.template.body.getBoundingClientRect().height + "px")
                            : (e.player.template.lrcWrap.style.bottom =
                                "calc(" +
                                String(
                                Number(e.player.template.body.getBoundingClientRect().height) - 1,
                                ) +
                                "px + 15vh)");
                    });
                },
              },
              {
                ...
                value: function () {
                    var e = this;
                    let ad;
                    "mini" === e.player.mode ? (ad = "collapsed") : (ad = "expanded");
                    sessionStorage.getItem("musicMode") ? sessionStorage.getItem("musicMode") === "mini" ? (e.aa = "collapsed") : (e.aa = "expanded") : (e.aa = ad);
                    function aa() {
                        if (e.aa === "collapsed") {
                            (e.player.template.lrcButton.classList.add("aplayer-icon-lrc-inactivity"),
                            ...
                            if (e.ab === "hided") {
                                ...
                                (e.player.template.lrcButton.classList.remove("aplayer-icon-lrc-inactivity"),
                    ...
                    this.player.template.miniSwitcher.addEventListener("click", function () {
                        ...
                        "mini" === e.player.mode ? (e.aa = "collapsed") : (e.aa = "expanded");
                        aa();
                    });
                },
              },
              ...
              },
              {
                ...
                value: function () {
                    var e = this;
                    sessionStorage.getItem("ab") ? (e.ab = sessionStorage.getItem("ab")) : null;
                    "hided" === e.ab ? (e.player.template.lrcButton.classList.add("aplayer-icon-lrc-inactivity"),
                        e.player.lrc && e.player.lrc.hide()) : (e.player.template.lrcButton.classList.remove("aplayer-icon-lrc-inactivity"),
                        e.player.lrc && e.player.lrc.show());
                    this.player.template.lrcButton.addEventListener("click", function () {
                        ...
                        ? (e.player.template.lrcButton.classList.remove(
                            ...
                            e.player.lrc && e.player.lrc.show()
                            ,(e.ab = "showed"),sessionStorage.setItem("ab", e.ab)
                        )
                        : (e.player.template.lrcButton.classList.add("aplayer-icon-lrc-inactivity"),
                            e.player.lrc && e.player.lrc.hide()
                            ,(e.ab = "hided"),sessionStorage.setItem("ab", e.ab)
                        );
                    });
                },
              },
          ...
          return (
            a(e, [
              ...
              },
              {
                key: "toggle",
                value: function () {
                  this.player.template.lrcWrap.classList.contains("aplayer-lrc-hide")
                    ? this.show()
                    : this.hide();
                },
              },
                  ...
                  if (!this.parsed[e])
                    if (this.async) {
                      ...
                      n.onreadystatechange = function () {
                        e === t.player.list.index &&
                          ...
                          ((n.status >= 200 && n.status < 300) || 304 === n.status
                            ...
                            : (t.player.notice("LRC file request fails: status " + n.status),
                      ...
                      this.player.list.audios[e].lrc
                        ? (this.parsed[e] = this.parse(this.player.list.audios[e].lrc))
                        : (this.parsed[e] = [["00:00", "Not available"]]);
                  (this.container.innerHTML = (0, o.default)({ lyrics: this.parsed[e] })),
                    this.update(0),
                        ...
                        for (var s = r.length, l = 0; l < s; l++) {
                          var u = /\[(\d{2}):(\d{2})(\.(\d{2,3}))?]/.exec(r[l]),
                            c =
                              60 * u[1] +
                              parseInt(u[2]) +
                              (u[4] ? parseInt(u[4]) / (2 === (u[4] + "").length ? 100 : 1e3) : 0);
                          n.push([c, o]);
                        }
                    }
                    return (
        ...
        (a.$escape = function (e) {
          return (function (e) {
            ...
            (function e(t) {
              return (
                "string" != typeof t &&
                  (t = null == t ? "" : "function" == typeof t ? e(t.call(t)) : JSON.stringify(t)),
                t
              );
            })(e),
          );
        ...
        return (
          ...
          a.fixed
            ? ((t += '\n<div class="aplayer-list'),
              ...
              (t += '"'),
              a.listMaxHeight &&
                ((t += ' style="max-height: '), (t += o(a.listMaxHeight)), (t += '"')),
              (t += ">\n    <ol"),
              a.listMaxHeight &&
                ((t += ' style="max-height: '), (t += o(a.listMaxHeight)), (t += '"')),
              (t += ">\n        "),
                ...
                value: function () {
                  ...
                  this.options.audio.length &&
                    ...
                    (this.skipForwardButton =
                      this.container.querySelector(".aplayer-icon-forward")),
    ...
    function (e, t, n) {
      ...
      function o() {
        f && h && ((f = !1), h.length ? (y = h.concat(y)) : (v = -1), y.length && s());
      }
      function s() {
        if (!f) {
          var e = r(o);
      ...
      (d.nextTick = function (e) {
        ...
        y.push(new l(e, t)), 1 !== y.length || f || r(s);
      }),
                ...
                ? ((o = h.documentElement),
                  (r = function (e) {
                    ...
                    (t.onreadystatechange = function () {
                      a(e), (t.onreadystatechange = null), o.removeChild(t), (t = null);
                    }),
                      o.appendChild(t);
                  }))
                : (r = function (e) {
            ...
            return new i(function (t, n) {
              function i(e, o) {
                try {
                  if (
                    o &&
                    ("object" === (void 0 === o ? "undefined" : u(o)) || "function" == typeof o)
                  ) {
                    var s = o.then;
              ...
              for (var r = a.length, o = 0; o < a.length; o++) i(o, a[o]);
            });
          }),
          (i.resolve = function (e) {
            return e && "object" === (void 0 === e ? "undefined" : u(e)) && e.constructor === i
              ? e
              : new i(function (t) {
                  t(e);
                });
        ...
        g = (function () {
          function e(t) {
            if (
              ...
              (this.options = (0, l.default)(t)),
              (this.container = this.options.container),
              (this.paused = !0),
              (this.playedPromise = r.default.resolve()),
              (this.mode = "normal"),
              (this.randomOrder = o.default.randomOrder(this.options.audio.length)),
              ...
              o.default.isMobile && this.container.classList.add("aplayer-mobile"),
              ...
              for (
                var n = this.container.getElementsByClassName("aplayer-lrc-content"), i = 0;
                i < n.length;
                i++
              )
                this.options.audio[i] && (this.options.audio[i].lrc = n[i].innerHTML);
            (this.template = new u.default({
              ...
              this.options.mini &&
                (this.setMode("mini"), (this.template.info.style.display = "block")),
              this.template.info.offsetWidth < 200 &&
                this.template.time.classList.add("aplayer-time-narrow"),
              this.options.lrcType &&
                (this.lrc = new d.default({
                  container: this.template.lrc,
                  async: 3 === this.options.lrcType,
                  player: this,
                })),
              (this.events = new f.default()),
              (this.storage = new p.default(this)),
              (this.bar = new c.default(this.template)),
              (this.controller = new h.default(this)),
              (this.timer = new y.default(this)),
              (this.list = new v.default(this)),
              this.initAudio(),
              this.bindEvents(),
              "random" === this.options.order
            ...
            a(
              ...
              [
                      ...
                      this.on("timeupdate", function () {
                        if (!e.disableTimeupdate) {
                          e.bar.set("played", e.audio.currentTime / e.duration, "width"),
                            e.lrc && e.lrc.update();
                          var t = o.default.secondToTime(e.audio.currentTime);
                          e.template.ptime.innerHTML !== t && (e.template.ptime.innerHTML = t);
                        }
                      }),
                      this.on("durationchange", function () {
                        1 !== e.duration &&
                          (e.template.dtime.innerHTML = o.default.secondToTime(e.duration));
                      }),
                      this.on("progress", function () {
                        var t = e.audio.buffered.length
                          ? e.audio.buffered.end(e.audio.buffered.length - 1) / e.duration
                          : 0;
                        ...
                        "none" === e.options.loop
                          ? "list" === e.options.order
                            ? e.list.index < e.list.audios.length - 1
                              ...
                              : (e.list.switch((e.list.index + 1) % e.list.audios.length),
                                e.pause())
                            : "random" === e.options.order &&
                              (e.randomOrder.indexOf(e.list.index) < e.randomOrder.length - 1
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    this.options.customAudioType && this.options.customAudioType[t]
                      ? "[object Function]" ===
                        Object.prototype.toString.call(this.options.customAudioType[t])
                ...
                },
                {
                  ...
                  value: function () {
                    var e =
                        arguments.length > 0 && void 0 !== arguments[0]
                          ? arguments[0]
                          : this.list.audios[this.list.index].theme || this.options.theme,
                      t =
                  ...
                  value: function () {
                    ...
                    if (
                      (this.paused &&
                        ...
                        setTimeout(function () {
                          e.template.button.innerHTML = s.default.pause;
                        }, 100),
                        (this.template.skipPlayButton.innerHTML = s.default.pause)),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this.paused ||
                      ...
                      (this.template.button.innerHTML = ""),
                      setTimeout(function () {
                        e.template.button.innerHTML = s.default.play;
                      }, 100),
                      (this.template.skipPlayButton.innerHTML = s.default.play)),
                ...
                },
                {
                  ...
                  value: function () {
                    this.volume() >= 0.95
                      ? (this.template.volumeButton.innerHTML = s.default.volumeUp)
                      : this.volume() > 0
                      ? (this.template.volumeButton.innerHTML = s.default.volumeDown)
                      : (this.template.volumeButton.innerHTML = s.default.volumeOff);
                  },
                },
                {
                  key: "volume",
                ...
                },
                {
                  ...
                  value: function () {
                    this.template.button.classList.contains("aplayer-play")
                      ? this.play()
                      : this.template.button.classList.contains("aplayer-pause") && this.pause();
                  },
                },
                {
                  key: "switchAudio",
                ...
                },
                {
                  ...
                  value: function () {
                    var e =
                      arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "normal";
                    (this.mode = e),
                      "mini" === e
                        ? this.container.classList.add("aplayer-narrow")
                        : "normal" === e && this.container.classList.remove("aplayer-narrow");
                  },
                },
                {
                  key: "notice",
