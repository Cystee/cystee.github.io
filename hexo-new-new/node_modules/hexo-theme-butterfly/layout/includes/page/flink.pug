                ...
                listResult += `
                  <div class="flink-list-item">
                    <a href="${lists[j].link}" title="${lists[j].name}" target="_blank">
                      <img class="no-lightbox flink-avatar cf-friends-avatar" src="${lists[j].avatar}" onerror='this.onerror=null;this.src="!{url_for(theme.error_img.flink)}"' alt="${lists[j].name}" />
                      <div class="flink-item-info">
                        <div class="flink-item-name cf-friends-name">${lists[j].name}</div> 
              ...
              listResult += `
                <div class="flink-list-item">
                  <a href="${j.link}" title="${j.name}" target="_blank">
                    <img class="no-lightbox flink-avatar cf-friends-avatar" src="${j.avatar}" onerror='this.onerror=null;this.src="${url_for(theme.error_img.flink)}"' alt="${j.name}" />
                    <div class="flink-item-info">
                      <span class="flink-item-name cf-friends-name">${j.name}</span> 
                      <span class="flink-item-desc" title="${j.descr}">${j.descr}</span>
                    </div>
                  </a>
                </div>`
            -
