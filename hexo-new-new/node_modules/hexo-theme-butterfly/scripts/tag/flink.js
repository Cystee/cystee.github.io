      ...
      listResult += `
          <div class="flink-list-item">
            <a href="${j.link}" title="${j.name}" target="_blank">
              <img class="no-lightbox flink-avatar cf-friends-avatar" src="${j.avatar}" onerror='this.onerror=null;this.src="${urlFor(hexo.theme.config.error_img.flink)}"' alt="${j.name}" />
              <div class="flink-item-info">
                <div class="flink-item-name cf-friends-name">${j.name}</div> 
